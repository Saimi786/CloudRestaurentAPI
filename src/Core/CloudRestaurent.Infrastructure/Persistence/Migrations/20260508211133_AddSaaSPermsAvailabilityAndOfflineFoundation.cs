...
{
    /// <inheritdoc />
    public partial class AddSaaSPermsAvailabilityAndOfflineFoundation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeatureNotes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientOccurredAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    StatusCode = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAvailabilityWindows_IsActive",
                table: "ProductAvailabilityWindows",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_ProductAvailabilityWindows_ProductId",
                table: "ProductAvailabilityWindows",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductAvailabilityWindows_TenantId",
                table: "ProductAvailabilityWindows",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SyncOperations_IdempotencyKey",
                table: "SyncOperations",
                column: "IdempotencyKey");

            migrationBuilder.CreateIndex(
                name: "IX_SyncOperations_OccurredAt",
                table: "SyncOperations",
                column: "OccurredAt");

            migrationBuilder.CreateIndex(
                name: "IX_SyncOperations_TenantId",
                table: "SyncOperations",
                column: "TenantId");
        }
