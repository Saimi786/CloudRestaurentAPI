        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Location_AddressLine1 = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Location_AddressLine2 = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    ...
                    Location_TimeZone = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnitGroups_TenantId",
                table: "UnitGroups",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitGroups_TenantId_Name",
                table: "UnitGroups",
                columns: new[] { "TenantId", "Name" },
                unique: true);
